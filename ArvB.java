...
public class ArvB {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Arvore movie = new Arvore(); // criar uma lista da classe List
        ...
        for (int i = 0; i < qtd; i++) {
            ...
            movie.inserir(entradas[i]); // inserir a entrada no final da lista
        }
        // ---------------------------------------------------------------------------------
        ...
        for (int i = 0; i < n; i++) {
            ...
            // ----- remover -----
                ...
                x2[i] = s2[i].substring(2); // guarda a string a ser removida
